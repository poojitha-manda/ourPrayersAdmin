import {
    ...
    FolderPlus,
    File,
    Command,Star, Cloud, Book, FileText, Server, Image, Sliders, Map, GitPullRequest, Calendar, Edit, Mail, MessageSquare, UserCheck, Layers, HelpCircle, Database, Headphones, Mic, ShoppingBag, Search, AlertOctagon, Lock, Briefcase, BarChart,Target, List, Package, Truck
} from 'react-feather';
...
export const MENUITEMS = [
    ...
    {
        title: 'Vendors', icon: Truck, type: 'sub', active: false, children: [
            { path: '/vendor/addvendor', title: 'Add Vendor', type: 'link' },
            { path: '/vendor/viewvendors', title: 'View Vendors', type: 'link' },
        ]
    },
    {
        title: 'Products', icon: Package, type: 'sub', active: false, children: [
            { path: '/product/addproduct', title: 'Add Product', type: 'link' },
            { path: '/product/viewproducts', title: 'View Products', type: 'link' },
        ]
    },
    {
        title: 'Users', icon: Users, type: 'sub', active: false, children: [
            { path: '/user/adduser', title: 'Add User', type: 'link' },
            { path: '/user/viewusers', title: 'View Users', type: 'link' },
        ]
    },
    {
        title: 'Orders', icon: ShoppingBag, type: 'sub', active: false, children: [
            { path: '/order/addorder', title: 'Add Order', type: 'link' },
            { path: '/order/vieworders', title: 'View Orders', type: 'link' },
        ]
    },
    {
        title: 'Popular', icon: Star, type: 'sub', active: false, children: [
            { path: '/popular/addpopular', title: 'Add Popular', type: 'link' },
            { path: '/popular/viewpopular', title: 'View Popular', type: 'link' },
        ]
    },
    {
