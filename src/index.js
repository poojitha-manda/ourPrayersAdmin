...
import EditPopular from './components/popular/EditPopular';
// widgets
                        ...
                        <Switch>
                            ...
                            {currentUser !== null || authenticated || jwt_token ?
                                ...
                                <App>
                                    ...
                                    PANEL */}
                                    {/* Vendor */}
                                    <Route path={`${process.env.PUBLIC_URL}/vendor/addvendor`} component={AddVendor} />
                                    <Route path={`${process.env.PUBLIC_URL}/vendor/viewvendors`} component={ViewVendors} />
                                    <Route path={`${process.env.PUBLIC_URL}/vendor/editvendor`} component={EditVendor} />

                                    {/* Products */}
                                    <Route path={`${process.env.PUBLIC_URL}/product/addproduct`} component={AddProduct} />
                                    <Route path={`${process.env.PUBLIC_URL}/product/viewproducts`} component={ViewProducts} />
                                    <Route path={`${process.env.PUBLIC_URL}/product/editproduct`} component={EditProduct} />

                                    
                                    {/* Users */}
                                    <Route path={`${process.env.PUBLIC_URL}/user/edituser`} component={EditUser} />
                                    <Route path={`${process.env.PUBLIC_URL}/user/adduser`} component={AddUser} />
                                    <Route path={`${process.env.PUBLIC_URL}/user/viewusers`} component={ViewUsers} />

                                     {/* Orders */}
                                     <Route path={`${process.env.PUBLIC_URL}/order/editorder`} component={EditOrder} />
                                    <Route path={`${process.env.PUBLIC_URL}/order/addorder`} component={AddOrder} />
                                    <Route path={`${process.env.PUBLIC_URL}/order/vieworders`} component={ViewOrders} />
                                    {/* Popular */}
                                    <Route path={`${process.env.PUBLIC_URL}/popular/editpopular`} component={EditPopular} />
                                    <Route path={`${process.env.PUBLIC_URL}/popular/addpopular`} component={AddPopular} />
                                    <Route path={`${process.env.PUBLIC_URL}/popular/viewpopular`} component={ViewPopular} />
